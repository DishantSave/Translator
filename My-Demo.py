...
###################### Buttons
imgbt1 = PhotoImage(file='Sentence Game.png')
imgbt2 = PhotoImage(file='Word Game.png')

imgbt1 = imgbt1.subsample(8, 8)
imgbt2 = imgbt2.subsample(8, 8)

btn1 = Button(root, text='Click', bd=10, bg='yellow', activebackground='red', width=100,
              font=('times', 15, 'italic bold'),
              image=imgbt1, compound=RIGHT, command=tt)
btn1.place(x=70, y=170)

btn2 = Button(root, text='Exit', bd=10, bg='yellow', activebackground='red', width=100,
              font=('times', 15, 'italic bold'),
